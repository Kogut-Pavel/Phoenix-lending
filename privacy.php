...
8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://daddysweb.ru/privacy.php"><mark>https://daddysweb.ru/privacy.php</mark></a>.<br><br><br>
<a href="<?php

                               $url = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                            $url = explode('privacy.php', $url);
                            $result = $url[0];
                            echo $result;

                            ?>">На главную</a><br><br><br>
</span>
